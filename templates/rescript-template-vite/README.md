...
- [ReScript](https://rescript-lang.org) with JSX v4, [@rescript/react](https://github.com/rescript-lang/rescript-react), and [@rescript/core](https://github.com/rescript-lang/rescript-core) when required by the selected ReScript version
